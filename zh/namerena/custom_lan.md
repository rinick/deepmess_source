...
* 英文版：[/?l=lang%2Fen.json](https://ulugo.com/namerena/?l=lang%2Fen.json)
* 繁体中文：[/?l=lang%2Fzh-TW.json](https://ulugo.com/namerena/?l=lang%2Fzh-TW.json)

#### 改变内容：

* 大富翁：[/#l=lang%2zh-money.json](https://ulugo.com/namerena/?l=lang%2Fzh-money.json) <br/>
...
* 首先下载默认的语言文件：<a href='https://ulugo.com/namerena/lang/zh.json' download>/lang/zh.json</a>
...
function openUrl(){
	...
	var url = "https://ulugo.com/namerena/?l=" + input.replace(/:/g,'%3A').replace(/\//g,'%2F').replace(/&/g,'%26').replace(/\?/g,'%3F');
