...
* 英文版：[/?l=lang%2Fen.json](http://namerena.github.io/?l=lang%2Fen.json)
* 繁体中文：[/?l=lang%2Fzh-TW.json](http://namerena.github.io/?l=lang%2Fzh-TW.json)

#### 改变内容：

* 大富翁：[/#l=lang%2zh-money.json](http://namerena.github.io/?l=lang%2Fzh-money.json) <br/>
...
* 首先下载默认的语言文件：<a href='http://namerena.github.io/lang/zh.json' download>/lang/zh.json</a>
...
function openUrl(){
	...
	var url = "http://namerena.github.io/?l=" + input.replace(/:/g,'%3A').replace(/\//g,'%2F').replace(/&/g,'%26').replace(/\?/g,'%3F');
